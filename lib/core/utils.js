 ...
 */
module.exports.npmInstall = (dependencies, ignoreYarn) => new Promise((resolve, reject) => {
  const useYarn = fs.existsSync(module.exports.getFromApp('yarn.lock')) && !ignoreYarn
