...
class App {
  ...
  configureStaticFiles() {
    this.use(this.config.get('publicPath'), express.static(path.resolve(this.getFromProject('node_modules'), pkg.name, "dependencies")))
    this.use(this.config.get('publicPath'), express.static(this.config.get('dirs.static')))
  }
