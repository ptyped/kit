...
describe('Expect dependencies to fetch correctly', () => {
    ...
    const paths = [
        ...
        ['Direct unprefixed', 'https://github.com/ptyped/ptyped-kit-starter.git','ptyped-kit-starter'],
        ['Direct zip', 'direct:https://github.com/ptyped/ptyped-kit-starter/archive/master.zip','ptyped-kit-starter'],
